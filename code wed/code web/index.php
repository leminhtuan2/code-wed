...
<head>
    ...
    <title> Trang Chủ - Toyota Lê Minh Tuấn </title>
</head>
                    ...
                    <div class="product2-toyota">
                        ...
                        <div class="product2-toyotaxe">
                            ...
                            <div class="product-item1 product-xe">
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/productCorolla4.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>Toyota vios 1.5G trd (CVT)</h3>
                                        <p>Vios</p>
                                ...
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/productCorolla5.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>Toyota vios 1.5G trd (CVT)</h3>
                                        <p>Vios</p>
                                ...
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/productCorolla6.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>Toyota vios 1.5G trd (CVT)</h3>
                                        <p>Vios</p>
                ...
                <div class="youtubeposts-wrapper">
                    <div class="box-youtube">
                        <div class="youtube-wrapper">
                            <iframe width="500" height="325" src="https://www.youtube.com/embed/KVzprvJ5_3I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="box-posts">
            ...
            <footer>
                <div class="footer1">
                    <div class="footer1-left">
                        ...
                        <h3>
                            <b>Xí Nghiệp Toyota Nông Trang, Việt Trì </b> là doanh nghiệp nhà nước trực thuộc Tổng Công ty Vận tải Hà Nội được thành lập ngày 10/5/1997.<br>
