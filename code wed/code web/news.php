...
<head>
    ...
    <title>Tin Tức - Lê Minh Tuấn </title>
</head>
<body>
    <div class="wrapper">
        <header>
                    ...
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            ...
                            <div class="title-news">
                                <h2>Chọn màu xe ô tô theo mệnh(ngũ hành) và năm sinh</h2>
                                <p>Nhiều người cho rằng, việc chọn màu xe phù hợp với tuổi sẽ khiến chiếc[...]</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            ...
                            <div class="title-news">
                                <h2>Toyota giới thiệu phiên bản Innova 2.0X</h2>
                                <p>Toyota vừa chính thức giới thiệu một phiên bản hoàn toàn mới, cũng trở thành[...]</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            ...
                            <div class="title-news">
                                <h2>Ô tô Việt khóc, cười vì chính sách thuế mới</h2>
                                <p>Chắc chắn sẽ có những doanh nghiệp sản xuất, lắp ráp ô tô tại Việt[...]</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
                        <div class="news-item">
                            ...
                            <div class="title-news">
                                <h2>Giá ô tô ở Việt Nam còn giảm tiép hay dừng lại?</h2>
                                <p>Hãng xe tiến thoái lưỡng nan, không giảm giá thì khó lòng xả hàng tồn[...]</p>
                            </div>
                        </div>
                    </a>
                    <a href="../html/newsinformation.html">
